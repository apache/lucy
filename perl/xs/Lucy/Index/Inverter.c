...
S_fetch_entry(lucy_Inverter *self, HE *hash_entry)
{
...

    {
        ...
        if (!entry) {
            entry 
                = lucy_InvEntry_new(schema, (lucy_CharBuf*)field, field_num);
    ...
    while (num_keys--) {
        ...
        switch (
            ...
            case lucy_FType_TEXT: {
                ...
                lucy_ViewCharBuf *value = (lucy_ViewCharBuf*)inv_entry->value;
            ...
            case lucy_FType_BLOB: {
                ...
                lucy_ViewByteBuf *value = (lucy_ViewByteBuf*)inv_entry->value;
